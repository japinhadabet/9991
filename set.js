! function(e) {
    ...
    t.exports = function(t) {
        return o(d, t) || (s && o(c, t) ? d[t] = c[t] : d[t] = u("Symbol." + t)), d[t]
    }
}, function(t, n) {
    t.exports = function(t) {
        try {
    ...
    var c = e(0),
        ...
        f = e(48);
    t.exports = function(t, n) {
        var e, i, r, o, a = t.target,
            s = t.global,
            d = t.stat;
        if (e = s ? c : d ? c[a] || m(a, {}) : (c[a] || {}).prototype)
            for (i in n) {
                if (r = n[i], o = t.noTargetGet ? (o = u(e, i)) && o.value : e[i], !f(s ? i : a + (d ? "." : "#") + i, t.forced) && void 0 !== o) {
    ...
    (function(t) {
        ...
        function d(t) {
            ...
            for (var n, e, i = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, r = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, o = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, a = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, s = /\((\S*)(?::(\d+))(?::(\d+))\)/, d = t.stack.split("\n"), c = [], u = /^(.*) is undefined$/.exec(t.message), l = 0, A = d.length; l < A; ++l) {
                if (e = i.exec(d[l])) {
                    ...
                    e[2] && 0 === e[2].indexOf("eval") && (n = s.exec(e[2])) && (e[2] = n[1], e[3] = n[2], e[4] = n[3]), m = {
                        url: m ? null : e[2],
                        func: e[1] || "?",
                        args: m ? [e[2]] : [],
                        line: e[3] ? +e[3] : null,
                    ...
                    e[3] && -1 < e[3].indexOf(" > eval") && (n = a.exec(e[3])) ? (e[3] = n[1], e[4] = n[2], e[5] = null) : 0 !== l || e[5] || I(t.columnNumber) || (c[0].column = t.columnNumber + 1), m = {
                        url: e[3],
                        func: e[1] || "?",
                        args: e[2] ? e[2].split(",") : [],
                        line: e[4] ? +e[4] : null,
                ...
                }!m.func && m.line && (m.func = w(m.url, m.line)), m.context = m.line ? y(m.url, m.line) : null, c.push(m)
            }
        ...
        function f(t, n, e, i) {
            ...
            if (e.url && e.line) {
                t.incomplete = !1, e.func || (e.func = w(e.url, e.line)), e.context || (e.context = y(e.url, e.line));
                i = / '([^']+)' /.exec(i);
                if (i && (e.column = p(i[1], e.url, e.line)), 0 < t.stack.length && t.stack[0].url === e.url) {
                    if (t.stack[0].line === e.line) return !1;
                    if (!t.stack[0].line && t.stack[0].func === e.func) return t.stack[0].line = e.line, t.stack[0].context = e.context, !1
                }
        ...
        function v(t, n) {
            for (var e, i, r, o, a = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, s = [], d = {}, c = !1, u = v.caller; u && !c; u = u.caller)
                if (u !== S && u !== l.report) {
                    if (i = {
                            ...
                            line: null,
                            column: null
                        }, u.name ? i.func = u.name : (e = a.exec(u.toString())) && (i.func = e[1]), void 0 === i.func) try {
                        i.func = e.input.substring(0, e.input.indexOf("{"))
                    } catch (t) {}(r = function(t) {
                        if (!I(g && g.document)) {
                            for (var n, e, i, r = [g.location.href], o = g.document.getElementsByTagName("script"), a = "" + t, s = 0; s < o.length; ++s) {
                                var d = o[s];
                                d.src && r.push(d.src)
                            }
                            if (e = k((n = /^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(a)) ? (t = n[1] ? "\\s+" + n[1] : "", e = n[2].split(",").join("\\s*,\\s*"), i = m(n[3]).replace(/;$/, ";?"), new RegExp("function" + t + "\\s*\\(\\s*" + e + "\\s*\\)\\s*{\\s*" + i + "\\s*}")) : new RegExp(m(a).replace(/\s+/g, "\\s+")), r)) return e;
                            if (n = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(a)) {
                                a = n[1];
                                if (i = b(n[2]), e = k(new RegExp("on" + a + "=[\\'\"]\\s*" + i + "\\s*[\\'\"]", "i"), r[0])) return e;
                                if (e = k(new RegExp(i), r)) return e
                            }
                            return null
                        }
                    }(u)) && (i.url = r.url, i.line = r.line, "?" === i.func && (i.func = w(i.url, i.line)), (o = / '([^']+)' /.exec(t.message || t.description)) && (i.column = p(o[1], r.url, r.line))), d["" + u] ? c = !0 : d["" + u] = !0, s.push(i)
                }
            n && s.splice(0, n);
            n = {
                mode: "callers",
            ...
            return f(n, t.sourceURL || t.fileName, t.line || t.lineNumber, t.message || t.description), n
        }
        ...
        function S(t, n) {
                        ...
                        if (n) {
                            for (var e, i = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, r = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\))? in (.*):\s*$/i, o = n.split("\n"), a = [], s = 0; s < o.length; s += 2) {
                                ...
                                if ((e = i.exec(o[s])) ? d = {
                                    ...
                                    if (!d.func && d.line && (d.func = w(d.url, d.line)), d.line) try {
            ...
            try {
                if (e = function(t) {
                        ...
                        var e, i = /^\s*Line (\d+) of linked script ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i,
                            r = /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i,
                            o = /^\s*Line (\d+) of function script\s*$/i,
                            a = [],
                            s = g && g.document && g.document.getElementsByTagName("script"),
                            d = [];
                        ...
                        for (var c = 2; c < n.length; c += 2) {
                            ...
                            (p = i.exec(n[c])) ? f = {
                                ...
                                line: +p[1],
                                column: null
                            }, u = +p[1], (A = d[p[2] - 1]) && (!(l = h(f.url)) || 0 <= (A = (l = l.join("\n")).indexOf(A.innerText)) && (f.line = u + l.substring(0, A).split("\n").length))) : (p = o.exec(n[c])) && (f = {
                                url: m = g.location.href.replace(/#.*$/, ""),
                                func: "",
                                args: [],
                                line: (m = k(new RegExp(b(n[c + 1])), [m])) ? m.line : p[1],
                                column: null
                            }), f && (f.func || (f.func = w(f.url, f.line)), p = (m = y(f.url, f.line)) ? m[Math.floor(m.length / 2)] : null, m && p.replace(/^\s*/, "") === n[c + 1].replace(/^\s*/, "") ? f.context = m : f.context = [n[c + 1]], a.push(f))
                        }
                        return a.length ? {
                            mode: "multiline",
                            name: t.name,
        ...
        function x(t, n, e, i, r) {
            var o, a, s, d;
            return A ? (l.computeStackTrace.augmentStackTraceWithInitialElement(A, n, e, t), T()) : r ? E(l.computeStackTrace(r), !0, r) : (a = {
                url: n,
                line: e,
                column: i
            }, s = t, "[object String]" !== {}.toString.call(t) || (d = t.match(c)) && (o = d[1], s = d[2]), a.func = l.computeStackTrace.guessFunctionName(a.url, a.line), a.context = l.computeStackTrace.gatherContext(a.url, a.line), E({
                name: o,
                message: s,
                mode: "onerror",
                stack: [a]
            }, !0, null)), !!u && u.apply(this, arguments)
        }
        ...
        function z(t) {
            ...
            throw A = n, s = t, setTimeout(function() {
                s === t && T()
        ...
        function I(t) {
            return void 0 === t
        }(g = "undefined" != typeof window ? window : t) && (l = {}, e = g.TraceKit, i = [].slice, c = /^(?:[Uu]ncaught (?:exception: )?)?(?:((?:Eval|Internal|Range|Reference|Syntax|Type|URI|)Error): )?(.*)$/, l.noConflict = function() {
        ...
        }, l.report = (a = [], A = s = null, z.subscribe = function(t) {
            !0 !== o && (u = g.onerror, g.onerror = x, o = !0), a.push(t)
        }, z.unsubscribe = function(t) {
            for (var n = a.length - 1; 0 <= n; --n) a[n] === t && a.splice(n, 1);
            0 === a.length && (g.onerror = u, o = !1)
        }, z), l.computeStackTrace = (r = {}, S.augmentStackTraceWithInitialElement = f, S.computeStackTraceFromStackProp = d, S.guessFunctionName = w, S.gatherContext = y, S.ofCaller = function(n) {
            n = 1 + (null == n ? 0 : +n);
            try {
                throw new Error
            } catch (t) {
        ...
        }, S.getSource = h, S), l.extendToAsynchronousCallbacks = function() {
            function t(t) {
                var e = g[t];
                g[t] = function() {
                    var t = i.call(arguments),
                        n = t[0];
                    return "function" == typeof n && (t[0] = l.wrap(n)), e.apply ? e.apply(this, t) : e(t[0], t[1])
                }
            }
            t("setTimeout"), t("setInterval")
        }, l.remoteFetching || (l.remoteFetching = !0), l.collectWindowErrors || (l.collectWindowErrors = !0), (!l.linesOfContext || l.linesOfContext < 1) && (l.linesOfContext = 11), n = [], void 0 === (t = "function" == typeof(t = l) ? t.apply(B, n) : t) || (_.exports = t))
    }).call(this, t(37))
}, function(t, n, e) {
    var a = e(0),
        s = e(7),
    ...
    (t.exports = function(t, n, e, i) {
        var r = !!i && !!i.unsafe,
            o = !!i && !!i.enumerable,
            i = !!i && !!i.noTargetGet;
        "function" == typeof e && ("string" != typeof n || d(e, "name") || s(e, "name", n), u(e).source = l.join("string" == typeof n ? n : "")), t !== a ? (r ? !i && t[n] && (o = !0) : delete t[n], o ? t[n] = e : s(t, n, e)) : o ? t[n] = e : c(n, e)
    ...
    var i, r, o, a, s, d, c, u, l = e(71),
        ...
        e = e(29),
        A = A.WeakMap;
    c = l ? (i = new A, r = i.get, o = i.has, a = i.set, s = function(t, n) {
        return a.call(i, t, n), n
    }, d = function(t) {
        return r.call(i, t) || {}
    }, function(t) {
        return o.call(i, t)
    }) : (e[u = g("state")] = !0, s = function(t, n) {
        return p(t, u, n), n
    }, d = function(t) {
        return f(t, u) ? t[u] : {}
    }, function(t) {
        ...
        getterFor: function(e) {
            return function(t) {
                var n;
                if (!m(t) || (n = d(t)).type !== e) throw TypeError("Incompatible receiver, " + e + " required");
                return n
            }
        }
    }
    ...
    (t.exports = function(t, n, e, i, r) {
        ...
        if (r) o = t;
            ...
            if ("function" != typeof(r = h(t))) throw TypeError("Target is not iterable");
            if (p(r)) {
                for (a = 0, s = f(t.length); a < s; a++)
                    if ((d = i ? l(m(u = t[a])[0], u[1]) : l(t[a])) && d instanceof A) return d;
                return new A(!1)
            }
            o = r.call(t)
        }
        for (c = o.next; !(u = c.call(o)).done;)
            if ("object" == typeof(d = w(o, l, u.value, i)) && d && d instanceof A) return d;
        return new A(!1)
    }).stop = function(t) {
        return new A(!0, t)
    }
    ...
    var o, a = e(4),
        ...
        m = function() {
            ...
            m = o ? function(t) {
                ...
                return t = null, n
            }(o) : ((n = l("iframe")).style.display = "none", u.appendChild(n), n.src = String("javascript:"), (t = n.contentWindow.document).open(), t.write(r("document.F=Object")), t.close(), t.F);
            for (var e = d.length; e--;) delete m.prototype[d[e]];
            return m()
        };
    c[A] = !0, t.exports = Object.create || function(t, n) {
        var e;
        return null !== t ? (i.prototype = a(t), e = new i, i.prototype = null, e[A] = t) : e = m(), void 0 === n ? e : s(e, n)
    }
}, function(t, n, e) {
    var i = e(9).f,
        r = e(3),
    ...
    t.exports = function(t, n, e, i, r, o, a) {
        ...
        var d, c, u = n + " Iterator",
            l = !1,
            A = t.prototype,
            m = A[z] || A["@@iterator"] || r && A[r],
            p = !T && m || s(r),
            i = "Array" == n && A.entries || m;
        if (i && (t = w(i.call(new t)), x !== Object.prototype && t.next && (S || w(t) === x || (y ? y(t, x) : "function" != typeof t[z] && k(t, z, f)), b(t, u, !0, !0), S && (E[u] = f))), "values" == r && m && "values" !== m.name && (l = !0, p = function() {
                return m.call(this)
            }), S && !a || A[z] === p || k(A, z, p), E[n] = p, r)
            if (d = {
                    values: s("values"),
                    keys: o ? p : s("keys"),
                    entries: s("entries")
    ...
    var i, r = e(34),
        ...
        c = s("iterator"),
        e = !1;
    [].keys && ("next" in (s = [].keys()) ? (s = r(r(s))) !== Object.prototype && (i = s) : e = !0), null == i && (i = {}), d || a(i, c) || o(i, c, function() {
        return this
    }), t.exports = {
        IteratorPrototype: i,
    ...
    t.exports = Object.setPrototypeOf || ("__proto__" in {} ? function() {
        var e, i = !1,
            t = {};
        try {
            (e = Object.getOwnPropertyDescriptor(Object.prototype, "__proto__").set).call(t, []), i = t instanceof Array
        } catch (e) {}
        return function(t, n) {
    ...
    f && g || (f = function(t) {
        ...
        y.now(r(t))
    } : w && !m ? (w = (m = new w).port2, m.port1.onmessage = o, a = u(w.postMessage, w, 1)) : !s.addEventListener || "function" != typeof postMessage || s.importScripts || d(e) || "file:" === p.protocol ? a = "onreadystatechange" in A("script") ? function(t) {
        l.appendChild(A("script")).onreadystatechange = function() {
            l.removeChild(this), i(t)
        }
    } : function(t) {
        setTimeout(r(t), 0)
    } : (a = e, s.addEventListener("message", o, !1))), t.exports = {
        set: f,
        clear: g
    }
}, function(t, n, e) {
    ...
    t.exports = !r || i(function() {
        ...
        for (var e = g(t), i = arguments.length, r = 1, o = p.f, a = f.f; r < i;)
            for (var s, d = h(arguments[r++]), c = o ? m(d).concat(o(d)) : m(d), u = c.length, l = 0; l < u;) s = c[l++], A && !a.call(d, s) || (e[s] = d[s]);
        return e
    } : r
}, function(t, n, e) {
    ...
    t.exports = i ? Object.defineProperties : function(t, n) {
        s(t);
        for (var e, i = d(n), r = i.length, o = 0; o < r;) a.f(t, e = i[o++], n[e]);
        return t
    }
}, function(t, n, e) {
    var i = e(8);
    ...
    function o(l, A, m) {
        var p;
        A.notified || (A.notified = !0, p = A.reactions, _(function() {
            for (var t = A.value, n = 1 == A.state, e = 0; p.length > e;) {
                var i, r, o, a = p[e++],
                    ...
                    u = a.domain;
                try {
                    s ? (n || (2 === A.rejection && nt(l, A), A.rejection = 1), !0 === s ? i = t : (u && u.enter(), i = s(t), u && (u.exit(), o = !0)), i === a.promise ? c(Q("Promise-chain cycle")) : (r = f(i)) ? r.call(i, d, c) : d(i)) : c(t)
                } catch (t) {
                    u && !o && u.exit(), c(t)
                }
            }
    ...
    function r(t, n, e) {
        var i;
        Y ? ((i = H.createEvent("Event")).promise = n, i.reason = e, i.initEvent(t, !1, !0), m.dispatchEvent(i)) : i = {
            promise: n,
            reason: e
    ...
    function s(t, n, e, i) {
        n.done || (n.done = !0, i && (n = i), n.value = e, n.state = 2, o(t, n, !0))
    }
    var i, d, c, u, l = e(5),
        A = e(16),
        m = e(0),
        ...
        j = j(G, function() {
            ...
            var n = U.resolve(1);
            return (n.constructor = {})[Z] = t, !(n.then(function() {}) instanceof t)
        }),
        z = j || !z(function(t) {
        ...
        $ = function(e, i) {
            I.call(m, function() {
                ...
                if (tt(i) && (t = L(function() {
                    ...
                    }), i.rejection = J || tt(i) ? 2 : 1, t.error)) throw t.value
            })
        },
        tt = function(t) {
    ...
    j && (U = function(t) {
        ...
        then: function(t, n) {
            var e = X(this),
                i = q(C(this, U));
            return i.ok = "function" != typeof t || t, i.fail = "function" == typeof n && n, i.domain = J ? W.domain : void 0, e.parent = !0, e.reactions.push(i), 0 != e.state && o(this, e, !1), i.promise
        },
        catch: function(t) {
        ...
        var t = new i,
            n = N(t);
        this.promise = t, this.resolve = a(et, t, n), this.reject = a(s, t, n)
    }, D.f = q = function(t) {
        return t === U || t === c ? new d : K(t)
    }, A || "function" != typeof g || (u = g.prototype.then, h(g.prototype, "then", function(t, n) {
        var e = this;
    ...
    A || (i = function() {
        ...
        d.data = s = !s
    }) : e && e.resolve ? (c = e.resolve(void 0), u = c.then, function() {
        u.call(c, i)
    }) : function() {
        p.call(l, i)
    ...
    var i, r, o = e(0),
        ...
        o = o && o.versions,
        o = o && o.v8;
    o ? r = (i = o.split("."))[0] + i[1] : e && (!(i = e.match(/Edge\/(\d+)/)) || 74 <= i[1]) && (i = e.match(/Chrome\/(\d+)/)) && (r = i[1]), t.exports = r && +r
}, function(t, n, e) {
    "use strict";
    var i = e(5),
        r = e(16),
            ...
            var d = this,
                ...
                e = o(function() {
                    ...
                    m(t, function(t) {
                        var n = o++,
                            e = !1;
                        r.push(void 0), a++, i.call(d, t).then(function(t) {
                            e || s || (s = !0, c(t))
                        }, function(t) {
                            e || s || (e = !0, r[n] = t, --a || u(new(A("AggregateError"))(r, "No one promise resolved")))
                        })
    ...
    ! function(t) {
        ...
        function p(n) {
            this.map = {}, n instanceof p ? n.forEach(function(t, n) {
                this.append(n, t)
        ...
        function y() {
            return this.bodyUsed = !1, this._initBody = function(t) {
                ...
                else if (r && a && s(t)) this._bodyArrayBuffer = w(t.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer]);
                else {
                    if (!r || !ArrayBuffer.prototype.isPrototypeOf(t) && !d(t)) throw new Error("unsupported BodyInit type");
                ...
                var t, n, e = f(this);
                if (e) return e;
                if (this._bodyBlob) return t = this._bodyBlob, e = g(n = new FileReader), n.readAsText(t), e;
        ...
        function b(t, n) {
            ...
            if (t instanceof b) {
                ...
                this.url = t.url, this.credentials = t.credentials, n.headers || (this.headers = new p(t.headers)), this.method = t.method, this.mode = t.mode, i || null == t._bodyInit || (i = t._bodyInit, t.bodyUsed = !0)
            } else this.url = String(t);
            if (this.credentials = n.credentials || this.credentials || "omit", !n.headers && this.headers || (this.headers = new p(n.headers)), this.method = (t = (e = n.method || this.method || "GET").toUpperCase(), -1 < c.indexOf(t) ? t : e), this.mode = n.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && i) throw new TypeError("Body not allowed for GET or HEAD requests");
            this._initBody(i)
        }
        ...
        function k(t) {
            ...
            return t.trim().split("&").forEach(function(t) {
                var n;
                t && (t = (n = t.split("=")).shift().replace(/\+/g, " "), n = n.join("=").replace(/\+/g, " "), e.append(decodeURIComponent(t), decodeURIComponent(n)))
            }), e
        }

        function v(t, n) {
            n = n || {}, this.type = "default", this.status = void 0 === n.status ? 200 : n.status, this.ok = 200 <= this.status && this.status < 300, this.statusText = "statusText" in n ? n.statusText : "OK", this.headers = new p(n.headers), this.url = n.url || "", this._initBody(t)
        }
        t.fetch || (n = "URLSearchParams" in t, e = "Symbol" in t && "iterator" in Symbol, a = "FileReader" in t && "Blob" in t && function() {
            try {
                return new Blob, !0
            } catch (t) {
                return !1
            }
        }(), i = "FormData" in t, (r = "ArrayBuffer" in t) && (o = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"], s = function(t) {
        ...
        }, e && (p.prototype[Symbol.iterator] = p.prototype.entries), c = ["DELETE", "GET", "HEAD", "OPTIONS", "POST", "PUT"], b.prototype.clone = function() {
            return new b(this, {
                body: this._bodyInit
            })
        ...
        }, u = [301, 302, 303, 307, 308], v.redirect = function(t, n) {
        ...
        }, t.Headers = p, t.Request = b, t.Response = v, t.fetch = function(e, o) {
            return new Promise(function(i, t) {
                ...
                r.onload = function() {
                    var e, t = {
                        ...
                        headers: (n = r.getAllResponseHeaders() || "", e = new p, n.replace(/\r?\n[\t ]+/g, " ").split(/\r?\n/).forEach(function(t) {
                            var n = t.split(":"),
                                t = n.shift().trim();
                    ...
                    t(new TypeError("Network request failed"))
                }, r.open(n.method, n.url, !0), "include" === n.credentials ? r.withCredentials = !0 : "omit" === n.credentials && (r.withCredentials = !1), "responseType" in r && a && (r.responseType = "blob"), n.headers.forEach(function(t, n) {
    ...
    "document" in window.self && ("classList" in document.createElement("_") && (!document.createElementNS || "classList" in document.createElementNS("http://www.w3.org/2000/svg", "g")) || function(t) {
        ...
        if ("Element" in t) {
            var n = t.Element.prototype,
                ...
                s = function(t) {
                    for (var n = o.call(t.getAttribute("class") || ""), e = n ? n.split(/\s+/) : [], i = 0, r = e.length; i < r; i++) this.push(e[i]);
            ...
            if (r.prototype = Error.prototype, d.item = function(t) {
                    return this[t] || null
                }, d.contains = function(t) {
                    return -1 !== a(this, t += "")
                }, d.add = function() {
                    for (var t, n = arguments, e = 0, i = n.length, r = !1; - 1 === a(this, t = n[e] + "") && (this.push(t), r = !0), ++e < i;);
                    ...
                    var t, n, e = arguments,
                        ...
                        o = !1;
                    do {
                        for (n = a(this, t = e[i] + ""); - 1 !== n;) this.splice(n, 1), o = !0, n = a(this, t)
                    } while (++i < r);
        ...
        n.classList.add("c1", "c2"), n.classList.contains("c2") || ((t = function(t) {
            var i = DOMTokenList.prototype[t];
            DOMTokenList.prototype[t] = function(t) {
                for (var n = arguments.length, e = 0; e < n; e++) t = arguments[e], i.call(this, t)
            }
    ...
    var i = e(65),
        ...
        o = e(66),
        n = e.n(o);
    e(108), e(109), void 0 === Object.assign && (Object.assign = r.a), "undefined" == typeof Promise && (window.Promise = n.a);
    ...
    function w() {
        var o;
        window.__tcfapi || (o = {}, window.__tcfapi = function(t, n, e, i) {
            ...
            e && "function" == typeof o[e.callId] && (o[e.callId](e.returnValue, e.success), o[e.callId] = null)
        }, !1)), window.pbjs.que.push(function() {
    ...
    var c = e(11),
        ...
        b = (D.clearEventListeners = function() {
            ...
            var i, r = this;
            void 0 === t && (t = !1), t = !!t, Object.prototype.hasOwnProperty.call(this.listeners, n) || (this.listeners[n] = []), t ? (i = function(t) {
            ...
            for (var e = Object.keys(this.listeners), i = 0; i < e.length; i++) {
                var r = e[i];
                if (t === r)
                    for (var o = this.listeners[r], a = 0; a < o.length; a++) o[a](l(l({}, this.dataAnnotations), n))
            }
        ...
        }, D.listeners = {}, D.debug = !1, D.dataAnnotations = {}, D),
        ...
        k = (B.setDebug = function(t) {
            ...
            var t, e = ((t = {})[y.ready] = y.tracking.sdk.status.initialized, t[y.adblocked] = y.tracking.sdk.status.failed, t[y.ads.busy] = y.tracking.ads.status.busy, t[y.ads.completed] = y.tracking.ads.status.completed, t[y.ads.error] = y.tracking.ads.status.error, t[y.ads.displayError] = y.tracking.ads.status.displayError, t[y.ads.impression] = y.tracking.ads.status.impression, t[y.ads.limit] = y.tracking.ads.status.limit, t[y.ads.ready] = y.tracking.ads.status.ready, t[y.ads.requested] = y.tracking.ads.status.requested, t[y.ads.prebidRequested] = y.tracking.ads.status.prebidRequested, t[y.ads.skipped] = y.tracking.ads.status.skipped, t[y.ads.started] = y.tracking.ads.status.started, t[y.ads.video.clicked] = y.tracking.ads.video.clicked, t[y.ads.video.error] = y.tracking.ads.video.error, t[y.ads.video.loaderError] = y.tracking.ads.video.loaderError, t[y.ads.video.buffering] = y.tracking.ads.status.buffering, t[y.tracking.screen.gameplayStart] = y.tracking.screen.gameplayStart, t[y.tracking.screen.gameplayStop] = y.tracking.screen.gameplayStop, t[y.tracking.screen.loadingProgress] = y.tracking.screen.loadingProgress, t[y.tracking.screen.commercialBreak] = y.tracking.screen.commercialBreak, t[y.tracking.screen.rewardedBreak] = y.tracking.screen.rewardedBreak, t[y.tracking.screen.happyTime] = y.tracking.screen.happyTime, t);
        ...
        r = (o = parseInt(E("site_id"), 10) || 0, r = d() || g() || h() ? ["video/mp4"] : ["video/mp4", "video/webm", "video/ogg"], {
            bids: [{
                bidder: "appnexus",
                params: T(T({
    ...
    function _(t) {
        ...
        }, b.addEventListener(y.ads.requested, this.startTimeBetweenAdsTimer.bind(this)), b.addEventListener(y.ads.completed, this.startTimeBetweenAdsTimer.bind(this)), b.addEventListener(y.ads.stopped, this.startTimeBetweenAdsTimer.bind(this))
    }
    ...
    var L = (G.prototype.moveThroughWaterfall = function() {
            if (!1 !== this.running) {
                ...
                this.running = !1, this.timing.resetWaterfallTimerIdx(), b.dispatchEvent(y.ads.error, {
                    message: "No ads"
                })
            }
            ...
            if (0 < this.overwriteAdTagUrls.length && lt.GetIsPokiPlatform()) return this.overwriteAdTagUrls;
            var i = "desktop",
                e = "midroll";
            g() ? i = "mobile" : h() && (i = "tablet"), t === y.ads.position.rewarded && (e = "rewarded");
            ...
            void 0 === t && (t = {}), this.running = !0, this.retries = 0, this.criteria = t, this.timing.resetWaterfallTimerIdx(), this.rewarded = n === y.ads.position.rewarded, this.adTagUrls = this.buildAdTagUrls(n), this.requestAd()
        }, G.prototype.requestAd = function() {
            this.timing.startWaterfallTimer(this.cutOffWaterfall.bind(this)), this.retries++, lt.GetIsPokiPlatform() || (this.criteria.waterfall = this.retries);
            ...
            var e, i, r, o, a, s, d, c, u, l, n = (t = n, n = A().split("?"), n = encodeURIComponent(n[0]), (t = t.split("{descriptionUrl}").join(n)).split("{timestamp}").join((new Date).getTime().toString()) + (e = this.criteria, i = "", Object.keys(e).forEach(function(t) {
                var n;
                Object.prototype.hasOwnProperty.call(e, t) && (n = e[t], Array.isArray(n) && (n = n.join()), i += t + "=" + n + "&")
            }), "&cust_params=" + (i = encodeURIComponent(i)) + "&"));
            lt.childDirected && (n += "&tfcd=1"), lt.nonPersonalized && (n += "&npa=1"), b.setDataAnnotations({
                adTagUrl: n,
                waterfall: this.retries
            }), b.dispatchEvent(y.ads.requested), 1 !== this.retries || g() || h() ? (console.debug("adRequest started in plain mode"), this.ima.requestAd(n)) : (console.debug("adRequest started with Prebid Video enabled"), r = this.ima, o = n, a = this.criteria, t = this.rewarded, window.pbjs && window.pbjs.que && window.pbjs.getConfig ? (n = A().split("?"), d = encodeURIComponent(n[0]), c = t ? "rewarded" : "video", u = 1, l = function() {
                if (!(0 < --u)) try {
                    b.dispatchEvent(y.ads.prebidRequested);
                    var t = window.pbjs.adUnits.filter(function(t) {
                        return t.code === c
                    })[0];
                    if ("undefined" === t) return console.error("Video-ad-unit not found, did you give it the adunit.code='video' value?"), void r.requestAd(o);
                    ...
                    window.pbjs.markWinningBidAsUsed({
                        adUnitCode: c
                    }), s && (t = t.replace("cust_params=", "cust_params=" + s + "%26")), r.requestAd(t)
                } catch (t) {
                    r.requestAd(o)
                }
            }, I && (u++, window.apstag.fetchBids({
                slots: [{
    ...
    function V(r) {
        return new Promise(function(t, n) {
            ...
            function i() {
                e.readyState && "loaded" !== e.readyState && "complete" !== e.readyState || (t(), e.onload = null, e.onreadystatechange = null)
            }
            e.onload = i, e.onreadystatechange = i, e.onerror = n, document.head.appendChild(e)
        })
    }
    ...
    var J = (Y.prototype.initAdDisplayContainer = function() {
        ...
        return H(this, void 0, void 0, function() {
            ...
            return W(this, function(t) {
                switch (t.label) {
                    case 0:
                        return this.runningAd ? [2] : (this.runningAd = !0, this.adDisplayContainer.initialize(), this.videoElement.src = "", (n = new google.ima.AdsRequest).adTagUrl = e, n.linearAdSlotWidth = this.currentWidth, n.linearAdSlotHeight = this.currentHeight, n.nonLinearAdSlotWidth = this.currentWidth, n.nonLinearAdSlotHeight = this.currentHeight, n.forceNonLinearFullSlot = !0, [4, this.canWeAutoPlayWithSound()]);
                    case 1:
                        return t.sent() ? (n.setAdWillPlayMuted(!1), this.currentRequestIsMuted = !1) : (n.setAdWillPlayMuted(!0), this.currentRequestIsMuted = !0), this.allowedToPlayAd = !0, this.adsLoader.requestAds(n), [2]
                }
            })
        })
        ...
        n.enablePreloading = !0, n.restoreCustomPlaybackStateOnAdBreakComplete = !0, n.mimeTypes = d() || g() || h() ? ["video/mp4"] : ["video/mp4", "video/webm", "video/ogg"], this.adsManager = t.getAdsManager(this.videoElement, n), this.adsManager.setVolume(Math.max(0, Math.min(1, this.volume))), this.currentRequestIsMuted && this.adsManager.setVolume(0), this.allowedToPlayAd ? (this.attachAdEvents(), b.dispatchEvent(y.ads.ready)) : this.tearDown()
        ...
        b.dispatchEvent(y.ads.video.resumed), this.adsManager && this.adsManager.resume()
        ...
        switch (t.type) {
            ...
            case google.ima.AdEvent.Type.STARTED:
                ...
                }, 1e3 * (t.remainingTime + 1))), b.dispatchEvent(y.ads.started, {
            ...
            case google.ima.AdEvent.Type.SKIPPED:
                b.dispatchEvent(y.ads.skipped), b.dispatchEvent(y.ads.completed), document.activeElement && document.activeElement.blur();
                break;
                ...
                b.dispatchEvent(y.ads.impression, {
                    userValueIndicator: function(t) {
                        try {
                            ...
                            var e = 0;
                            if (n) {
                                for (var i, r = 0; r < n.length; r++) window.pokiAuctionsSeen[t][n[r].auctionId] || (i = n[r].cpm) && e < i && (e = i);
                                for (r = 0; r < n.length; r++) window.pokiAuctionsSeen[t][n[r].auctionId] = !0
                            }
                            return e
                        } catch (t) {
                            console.error(t)
    ...
    function $() {
        ...
        return "/" !== t[0] && (t = "/" + t), encodeURIComponent(window.location.protocol + "//" + window.location.host + t + window.location.search), encodeURIComponent(document.referrer), fetch("", {
            method: "GET",
            headers: {
            ...
            return function(A) {
                return q(this, void 0, void 0, function() {
                    ...
                    return K(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return t.trys.push([0, 3, , 4]), "/" !== (n = window.location.pathname)[0] && (n = "/" + n), r = (i = JSON).stringify, o = {
                                    c: "sdk-p4d-error",
                                    ve: 7
                                }, a = {
                                    k: "error"
                            ...
                            case 2:
                                if (e = r.apply(i, [(o.d = [(a.v = d.apply(s, [(c.json = u, c.body = JSON.stringify({
                                    ...
                                    }), c.name = A.name, c.message = A.message, c)]), a)], o)]), navigator.sendBeacon) navigator.sendBeacon("", e);
                                else try {
                                    (l = new XMLHttpRequest).open("POST", "", !0), l.send(e)
                                } catch (t) {}
                                return [3, 4];
                            case 3:
                                return t.sent(), [3, 4];
    ...
    function tt() {
        return t = this, a = void 0, s = Promise, d = function() {
            var e, i, r, o, a, s, t;
            return e = this, i = function(t) {
                switch (t.label) {
                    case 0:
    ...
    function nt() {
        return d = function() {
            ...
            return i = this, r = function(t) {
                switch (t.label) {
                    case 0:
                        if (ot) return [2];
                        t.label = 1;
                    case 1:
                        return t.trys.push([1, 4, , 5]), [4, fetch("./touchControllerConfig.json")];
                    case 2:
                        return [4, t.sent().json()];
                    case 3:
                        return (n = t.sent()) && ((e = document.createElement("script")).src = "//game-cdn.poki.com/scripts/touchOverlayController.js", e.onload = function() {
                            new window.OverlayController(document.body, n)
                        }, document.head.appendChild(e), ot = !0), [3, 5];
                    case 4:
            ...
            function c(n) {
                return function(t) {
                    return function(n) {
                        ...
                        for (; d;) try {
                            if (o = 1, a && (s = 2 & n[0] ? a.return : n[0] ? a.throw || ((s = a.return) && s.call(a), 0) : a.next) && !(s = s.call(a, n[1])).done) return s;
    ...
    function et() {
        ...
        if (window.crypto && crypto.getRandomValues && Uint32Array) {
            ...
            for (crypto.getRandomValues(i), e = 0; e < 12; e++) n += String.fromCharCode(255 & i[e])
        } else
    ...
    var rt = e(67),
        ...
        dt = function(e) {
            googletag.cmd.push(function() {
                ...
                }), googletag.destroySlots([n.gptSlot]), null === (t = e.querySelector("div#" + n.id)) || void 0 === t || t.remove(), e.removeAttribute("data-poki-ad-id"), st.delete(n.id))
            })
        },
        ct = function() {
        ...
        lt = (At.prototype.init = function(t) {
            if (void 0 === t && (t = {}), "undefined" != typeof window) {
                var n = t.onReady,
                    ...
                    n = t.onAdblocked,
                    n = void 0 === n ? null : n;
                return this.initOptions = t, e && this.registerHandler("onReady", e), n && this.registerHandler("onAdblocked", n), this.isInitialized ? console.error("Poki SDK has already been initialized") : (this.initializingPromise || (this.initializingPromise = this.lazyLoadInit()), this.initializingPromise)
            }
            ...
            window.googletag = window.googletag || {
                cmd: []
            }, this.setupDefaultEvents(), k.setupDefaultEvents(), t = d, window.pbjs = window.pbjs || {}, window.pbjs.que = window.pbjs.que || [], window.pbjs.que.push(function() {
                window.pbjs.addAdUnits(t.adUnits || z), window.pbjs.setConfig(T(T({}, C), t.config)), window.pbjs.bidderSettings = {
                    districtm: {
            ...
            var p = ct({}, v);
            e ? (At.isPokiPlatform = !0, p = ct(ct({}, p), {
                adTagUrl: e,
                customCriteria: s,
                adTiming: o
            })) : At.isPokiPlatform = !1;
            ...
            return f && (o = function() {
            ...
            }), window.addEventListener("resize", this.resize.bind(this), !1), window.addEventListener("message", this.onMessage.bind(this), !1), this.debugIsOverwritten || this.setDebug(this.debug || r), this.debugTouchOverlayController && (g() || h()) && nt(), Promise.all([s(), o(), V(""), V(""), V(rt.a), V("")]).catch(function() {
                b.dispatchEvent(y.adblocked)
            }).then(function(t) {
                var n, e;
                void 0 !== t && (n = t[0], t = t[1], t = ct(ct({}, p), {
                    country: t
                }), n && (ut.gameId || (ut.gameId = n.gameId), ["7fb1fd45-24ce-4ade-b5c4-9ee55ec99526"].includes(ut.gameId) && (g() || h()) && nt(), t.adTiming = n.adTiming, t.customCriteria = ct(ct({}, t.customCriteria), {
                    p4d_game_id: ut.gameId
                })), i.debug && (t.adTiming.startAdsAfter = 0), i.enableSettings(t), (n = U(i.country)) && (At.GetIsPokiPlatform() || At.GetIsPokiIFrame()) && w(), i.playerSkin = new j({
                    wrapper: A
                }), i.ima = new J(u), i.playerSkin.setupEvents(i), i.startStartAdsAfterTimerOnInit && i.adTimings.startStartAdsAfterTimer(), i.waterfall = new L(i.ima, {
                    timing: i.adTimings,
                    totalRetries: l,
                    adTagUrl: t.adTagUrl,
                    siteID: m
                ...
                }), e = c, window.apstag && window.apstag.init(e.settings || T({
                ...
                }), i.isInitialized = !0, b.dispatchEvent(y.ready))
            })
            ...
            function t() {
                ...
                if (a.autoStartOnReady = !1 !== t, e && a.registerHandler("onFinish", e), i && a.registerHandler("onStart", i), a.forceDisableCommercialBreak && [y.ads.position.midroll, y.ads.position.preroll].includes(r)) e && e();
                else {
                    if (!a.sdkBooted) return b.dispatchEvent(y.ads.error, {
                    ...
                    a.sdkImaError ? b.dispatchEvent(y.ads.error, {
                        ...
                        position: r
                    }), !At.isPokiPlatform && r !== y.ads.position.rewarded || (e = ct(ct({}, e), n)), a.playerSkin.showWithOpacity(), a.resize(), a.waterfall.start(e, r)) : b.dispatchEvent(y.ads.limit, {
            ...
            function t() {
                ...
                if (c) {
                    if (!u.sdkBooted) return b.dispatchEvent(y.ads.error, {
                        message: "Requesting ad on unbooted SDK",
                        position: o
                    }), void u.sdkNotBootedButCalled();
                    if (d)
                        if (u.sdkImaError) b.dispatchEvent(y.ads.error, {
                            message: "Adblocker has been detected",
                            position: o
                        });
                        else {
                            if (s = c, !(g() || h() || ["970x250", "300x250", "728x90", "160x600", "320x50"].includes(s)) || (g() || h()) && !["320x50"].includes(s)) return b.dispatchEvent(y.ads.error, {
                            ...
                            var a = ct(ct({}, u.genericCriteria()), u.criteria),
                                s = function(n, t) {
                                    ...
                                    return st.set(r.id, r), googletag.cmd.push(function() {
                                        var t = document.createElement("div");
                                        t.id = r.id, t.className = "poki-ad-slot", t.style.width = r.width + "px", t.style.height = r.height + "px", t.setAttribute("data-poki-ad-size", r.size), n.appendChild(t), n.setAttribute("data-poki-ad-id", r.id), r.gptSlot = googletag.defineSlot(r.adUnitPath, [r.width, r.height], r.id).addService(googletag.pubads()), googletag.enableServices(), st.set(r.id, r)
                                    }), r.id
                                }(d, c);
                            i = s, r = a, googletag.cmd.push(function() {
                                var t, e = st.get(i);
                                e && e.gptSlot && (null === (t = e.gptSlot) || void 0 === t || t.clearTargeting(), Object.keys(r).forEach(function(t) {
                                    var n;
                                    null === (n = e.gptSlot) || void 0 === n || n.setTargeting(t, r[t])
                                }))
                            }), n = s, e = t, googletag.cmd.push(function() {
                                var t = st.get(n);
                                t && t.gptSlot && (t.opportunityId = e, k.track(y.tracking.ads.display.requested, {
                                    size: t.size,
                                    opportunityId: t.opportunityId,
                                    adUnitPath: t.adUnitPath
                                }), t.refresh && t.gptSlot ? googletag.pubads().refresh([t.gptSlot]) : (googletag.display(t.id), t.refresh = !0, st.set(t.id, t)))
                            })
                        }
                    else b.dispatchEvent(y.ads.error, {
            ...
            function n() {
                if (!e.sdkBooted) return b.dispatchEvent(y.ads.displayError, {
            ...
            this.criteria = ct({}, t.customCriteria), this.adTimings = new S(t.adTiming), this.country = t.country
            ...
            }("playerAge"), 10) || 0, e = U(i = this.country), t = F.includes(i), i = Q(i), (e || t || Q) && (e && n <= 12 || t && n <= 16 || i && n <= 16) ? this.disableProgrammatic() : this.enableProgrammatic()) : this.disableProgrammatic()
            ...
            var n = this;
            this.debugIsOverwritten ? t && k.track(y.tracking.debugTrueInProduction) : (k.setDebug(t), b.setDebug(t), this.waterfall ? this.waterfall.setDebug(t) : b.addEventListener(y.ready, function() {
            ...
            if (!this.sdkBooted) return this.sdkNotBootedButCalled();
            this.sdkImaError || (this.adReady ? (this.playerSkin.show(), this.resize(), this.ima.startPlayback()) : b.dispatchEvent(y.ads.error, {
        ...
        }, At.childDirected = !1, At.isPokiPlatform = !1, At.nonPersonalized = !1, At.consentString = "", At);
    ...
    function ht(t) {
        if (ut.gameId && ut.versionId) {
            if (!(Date.now() < ft)) {
                gt || (r = gt = Math.random().toString(36).substr(2, 9), document.cookie = "poki_erruid=" + r + "; path=/; samesite=lax; max-age=63072000; domain=" + pt);
                try {
                    ...
                    navigator.sendBeacon ? navigator.sendBeacon(i, e) : ((n = new XMLHttpRequest).open("POST", i, !0), n.send(e)), ft = Date.now() + 100
                } catch (t) {
                    console.error(t)
                }
            }
    ...
    function yt(t, n, e) {
        var i;
        null != t && ((i = t[n]) && i.__poki__ || (t[n] = e(i), t[n].__poki__ = !0, t[n].__orig__ = i))
    }
    ...
    function bt(i) {
        ...
        for (var n in i) e = i, r = n, Object.prototype.hasOwnProperty.call(e, r) && (t[n] = i[n]);
        var e, r;
        return t.prototype = i.prototype, (i.__poki_wrapper__ = t).__poki__ = !0, t.__orig__ = i, t
    }
    ...
    function kt(o) {
        return function(t, n) {
            ...
            var r = e[0];
            return wt(r) && (e[0] = bt(r)), o.apply ? o.apply(this, e) : o(e[0], e[1])
        }
    }
    "undefined" != typeof window && (u.a.remoteFetching = !1, u.a.report.subscribe(function(t) {
        var n;
        "Script error." === t.message && window.pokiLastCatch ? (n = window.pokiLastCatch, window.pokiLastCatch = null, u.a.report(n)) : ht(t)
    ...
    }), yt(window, "setTimeout", kt), yt(window, "setInterval", kt), void 0 !== window.requestAnimationFrame && yt(window, "requestAnimationFrame", function(n) {
        return function(t) {
            return n(bt(t))
        }
    })));
    ...
    function xt() {
        var i = this;
        this.gameStarted = !1, this.SDK = new lt, this.gameplayStartCounter = 0, this.gameplayStopCounter = 0, this.init = function(e) {
            return void 0 === e && (e = {}), new Promise(function(t, n) {
                e && e.adTagUrl && window && (window.__InternalSDK = i.SDK), i.SDK.init(St({
                    onReady: t,
                    onAdblocked: n
                }, e)), m.sendMessage(y.message.sdkDetails, {
                    version: "2.150.0"
                })
            })
            ...
            var n = {};
            void 0 !== t.percentageDone && (n.percentageDone = Number(t.percentageDone)), void 0 !== t.kbLoaded && (n.kbLoaded = Number(t.kbLoaded)), void 0 !== t.kbTotal && (n.kbTotal = Number(t.kbTotal)), void 0 !== t.fileNameLoaded && (n.fileNameLoaded = String(t.fileNameLoaded)), void 0 !== t.filesLoaded && (n.filesLoaded = Number(t.filesLoaded)), void 0 !== t.filesTotal && (n.filesTotal = Number(t.filesTotal)), k.track(y.tracking.screen.gameLoadingProgress, n)
            ...
            i.gameplayStartCounter++, i.gameStarted || (i.gameStarted = !0, k.track(y.tracking.screen.firstRound), i.SDK.startStartAdsAfterTimer()), k.track(y.tracking.screen.gameplayStart, St(St({}, t), {
            ...
            i.gameplayStopCounter++, k.track(y.tracking.screen.gameplayStop, St(St({}, t), {
                playId: i.gameplayStartCounter,
                stopId: i.gameplayStopCounter
            }))
        }, this.roundStart = function(t) {
            void 0 === t && (t = ""), t = String(t), k.track(y.tracking.screen.roundStart, {
                identifier: t
            })
        }, this.roundEnd = function(t) {
            void 0 === t && (t = ""), t = String(t), k.track(y.tracking.screen.roundEnd, {
                identifier: t
            })
        }, this.customEvent = function(t, n, e) {
            void 0 === e && (e = {}), t && n ? (t = String(t), n = String(n), e = St({}, e), k.track(y.tracking.custom, {
                eventNoun: t,
                eventVerb: n,
                eventData: e
            ...
            return new Promise(function(t) {
                ...
                b.clearAnnotations(), b.setDataAnnotations({
                    opportunityId: et(),
                    position: n
                }), k.track(y.tracking.screen.commercialBreak), i.SDK.requestAd({
                    position: n,
                    onFinish: t
                })
            })
            ...
            return new Promise(function(n) {
                ...
                b.clearAnnotations(), b.setDataAnnotations({
                    opportunityId: et(),
                    position: t
                }), k.track(y.tracking.screen.rewardedBreak), i.SDK.requestAd({
                    position: t,
                    onFinish: function(t) {
            ...
            void 0 === t && (t = 1), ((t = Number(t)) < 0 || 1 < t) && (t = Math.max(0, Math.min(1, t)), i.warning("happyTime", "Intensity should be a value between 0 and 1, adjusted to " + t)), k.track(y.tracking.screen.happyTime, {
                intensity: t
            })
            ...
            k.track(y.tracking.togglePlayerAdvertisingConsent, {
                didConsent: t
            }), i.SDK.togglePlayerAdvertisingConsent(t), m.sendMessage(y.message.toggleProgrammaticAds, {
        ...
        }, this.sendHighscore = function() {}, this.setDebugTouchOverlayController = function(t) {
